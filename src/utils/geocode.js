...
const geocode = (address, callback) => {
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + address + '.json?access_token=pk.eyJ1IjoiYXJ1bmt1bWFya3MiLCJhIjoiY2tpZnMxZGNlMDB3NTMzbzNua3Z2aHpoMCJ9.vhCdSK03ZuP8ZiNVrTRc9A'
